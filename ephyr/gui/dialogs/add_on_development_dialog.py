...
"""
    ...
    def _write_output_files(self, target_dir: Path, pyproject_content: str, example_content: str, project_name: str):
        package_dir = target_dir / "ephyr_add_ons" / project_name
        readme_content = (
            f"# {project_name}\n\n"
            "Generated add-on template.\n\n"
            "## Files\n"
            f"- `ephyr_add_ons/{project_name}/entry_point.py`: add-on implementation\n"
            f"- `ephyr_add_ons/{project_name}/__init__.py`: package marker for helpers\n"
    ...
    def _on_generate_clicked(self):
        ...
        try:
            ...
            existing_paths = [
                ...
                target_dir / "ephyr_add_ons" / project_name / "__init__.py",
                target_dir / "ephyr_add_ons" / project_name / "entry_point.py",
            ]
