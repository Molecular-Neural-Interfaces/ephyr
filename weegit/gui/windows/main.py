...
from weegit.gui.dialogs.converter_dialog import ConverterDialog
...
from weegit.gui.dialogs.add_ons_dialog import AddOnsDialog
...
from weegit.gui.panels.signal_settings_panel import SignalSettingsPanel
from weegit.gui.panels.signal_panel import SignalPanel
from weegit.gui.panels.start_screen_panel import StartScreenPanel
...
class MainWindow(QMainWindow, QWidgetMixin):
    ...
    def __init__(self, session_manager: QtWeegitSessionManagerWrapper, global_storage_manager: GlobalStorageManager):
        super().__init__()
        self.setWindowTitle(f"Weegit v{version.__version__}")
    ...
    def __open_experiment_path(self, experiment_path: Path):
        ...
        if not is_weegit and not WeegitIO.is_valid_weegit_folder(weegit_experiment_folder_path):
            ...
            converter_dialog = ConverterDialog(source_reader, weegit_experiment_folder_path, self)
            ...
            if file_to_import:
                ...
                try:
                    if file_path.suffix.lower() == ".mat":
                        ...
                        session_to_import = WeegitSessionManager.parse_session_file(file_path)
