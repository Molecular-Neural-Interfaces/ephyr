...
> Kireev, A., & Suchkov, D. (2026). *Ephyr: an open-source platform for visualizing and labeling multimodal electrophysiological data* (Version 1.0.0). Zenodo. https://doi.org/10.5281/zenodo.XXXXXXX
